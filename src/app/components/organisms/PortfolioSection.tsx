    ...
    <section className="pt-[77px] pb-[139px] px-[28px]">
      <div className="w-full max-w-[1377px] mx-auto">
        ...
        <p className="font-neu-mont mt-[20px] sm:mt-[25px] md:mt-[37px] text-center text-[14px] sm:text-base">
          Below you can see some tattoos with approximately price in 2025
        </p>

        <div
          id="portfolio"
          className="justify-center md:grid [grid-template-columns:repeat(auto-fit,minmax(200px,333px))] gap-[35px] md:gap-[15px] mt-10 xl:mt-15"
        >
